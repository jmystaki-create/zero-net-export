...
class SourceRepairGuidanceTests(unittest.TestCase):
    ...
    def test_detailed_management_handoff_keeps_review_first_guidance_when_fleet_is_empty(self) -> None:
        ...
        self.assertIn("as the secondary ⚙ Settings device-page review/audit path once the fleet exists", guidance)
    ...
    def test_detailed_management_handoff_keeps_device_page_secondary_when_fleet_exists(self) -> None:
        ...
        self.assertIn(native_support.DETAILED_MANAGEMENT_PATH, guidance)
        self.assertIn("as the secondary ⚙ Settings device-page review/audit path", guidance)
    ...
    def test_command_center_guide_text_includes_source_blocker_details(self) -> None:
        ...
        self.assertIn(f"- Current focus section: {native_support.SOURCES_SECTION_LABEL}", guide)
    ...
    def test_support_center_lists_each_native_path(self) -> None:
        ...
        self.assertNotIn("- Current focus section:", support_center)
    ...
    def test_detailed_management_path_uses_review_action_wording(self) -> None:
        ...
        self.assertIn("⚙ Settings — Open Managed Devices workspace", native_support.DETAILED_MANAGEMENT_PATH)
        self.assertIn("⚙ Settings — Open Managed Devices review", native_support.DETAILED_MANAGEMENT_PATH)
        self.assertNotIn("Review managed devices workspace", native_support.DETAILED_MANAGEMENT_PATH)
        self.assertIn("per-device ⚙ Settings — Managed Devices review buttons", native_support.DETAILED_MANAGEMENT_PATH)
        self.assertNotIn("per-device Managed Devices review buttons", native_support.DETAILED_MANAGEMENT_PATH)
