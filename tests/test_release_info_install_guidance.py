...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("Managed Load Dashboard", info["changes_preview"])
        self.assertIn("per-device watt display", info["changes_preview"])
        self.assertIn("candidate rows now show measured/supplied watts", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("Managed Devices", current_highlights)
        self.assertIn("Managed Load Dashboard", current_highlights)
        self.assertIn("per-device watt display", current_highlights)
        self.assertIn("candidate rows now show measured/supplied watts", current_highlights)
