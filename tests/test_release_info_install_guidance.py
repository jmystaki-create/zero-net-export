...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("command-center focus path", info["changes_preview"])
        self.assertIn("source-health blocker", info["changes_preview"])
        self.assertIn("template", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("command-center focus path", current_highlights)
        self.assertIn("Home Assistant", current_highlights)
        self.assertIn("source-health blocker", current_highlights)
        self.assertIn("template", current_highlights)
