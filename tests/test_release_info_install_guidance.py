...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("recorder-backed entity attributes", info["changes_preview"])
        self.assertIn("bulky action history", info["changes_preview"])
        self.assertIn("compact dashboard-safe summaries", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("recorder-backed entity attributes", current_highlights)
        self.assertIn("bulky action history", current_highlights)
        self.assertIn("compact dashboard-safe summaries", current_highlights)
