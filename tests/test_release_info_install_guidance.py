...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_current_candidate_changelog_tracks_managed_only_scope_without_stale_release_loop(self) -> None:
        ...
        self.assertIn("right-side settings/configuration affordance", current_highlights)
        self.assertIn("first-provisioned settings inventory", current_highlights)
        self.assertIn("release, deploy, Home Assistant restart", current_highlights)
