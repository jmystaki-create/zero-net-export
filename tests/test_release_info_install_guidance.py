...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("second tab position", info["changes_preview"])
        self.assertIn("Sources", info["changes_preview"])
        self.assertIn("Controls", info["changes_preview"])
        self.assertIn("Runtime", info["changes_preview"])
        self.assertIn("watt dashboard", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("Managed Devices", current_highlights)
        self.assertIn("second tab position", current_highlights)
        self.assertIn("Sources", current_highlights)
        self.assertIn("Controls", current_highlights)
        self.assertIn("Runtime", current_highlights)
        self.assertIn("watt dashboard", current_highlights)
