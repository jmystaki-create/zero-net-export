...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("disabled-active alert", info["changes_preview"])
        self.assertIn("0 W", info["changes_preview"])
        self.assertIn("confirm the real load", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("Managed Devices", current_highlights)
        self.assertIn("disabled-active alert", current_highlights)
        self.assertIn("0 W", current_highlights)
        self.assertIn("confirm the real load", current_highlights)
