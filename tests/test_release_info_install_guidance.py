...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("ZNE-592", info["changes_preview"])
        self.assertIn("removing the misleading managed-load device-page", info["changes_preview"])
        self.assertIn("configuration_url", info["changes_preview"])
        self.assertIn("zero_net_export.remove_managed_device", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_managed_device_actions_correction_scope(self) -> None:
        ...
        self.assertIn("ZNE-592", current_highlights)
        self.assertIn("removing the misleading managed-load device-page", current_highlights)
        self.assertIn("configuration_url", current_highlights)
        self.assertIn("Open configuration URL", current_highlights)
