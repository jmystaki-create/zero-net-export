...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertEqual(info["released_on"], "2026-07-17")
        ...
        self.assertIn("Power", info["changes_preview"])
        self.assertIn("traffic-light indicator", info["changes_preview"])
        self.assertIn("observed runtime", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("Power", current_highlights)
        self.assertIn("traffic-light indicator", current_highlights)
        self.assertIn("observed runtime", current_highlights)
