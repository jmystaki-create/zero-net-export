...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertEqual(info["released_on"], "2026-07-01")
        ...
        self.assertIn("ZNE-APP-003", info["changes_preview"])
        self.assertIn("Managed Devices fleet controls", info["changes_preview"])
        self.assertIn("confirmation-gated bulk enable/disable", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("ZNE-APP-003", current_highlights)
        self.assertIn("Managed Devices fleet controls", current_highlights)
        self.assertIn("priority/readiness filters", current_highlights)
        self.assertIn("confirmation-gated bulk enable/disable", current_highlights)
