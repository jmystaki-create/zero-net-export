...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertEqual(info["released_on"], "2026-07-09")
        ...
        self.assertIn("unmanaged Managed Devices candidate queue", info["changes_preview"])
        self.assertIn("helper entities", info["changes_preview"])
        self.assertIn("unmanaged promotion candidates", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("unmanaged Managed Devices candidate queue", current_highlights)
        self.assertIn("helper entities", current_highlights)
        self.assertIn("unmanaged promotion candidates", current_highlights)
