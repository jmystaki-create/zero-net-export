...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertIn("Review & promote", info["changes_preview"])
        self.assertIn("review panel above the unmanaged table", info["changes_preview"])
        self.assertIn("scrolling/focusing", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("Review & promote", current_highlights)
        self.assertIn("review panel above the unmanaged table", current_highlights)
        self.assertIn("scrolling/focusing", current_highlights)
