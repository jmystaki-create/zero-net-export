...
class ReleaseInfoInstallGuidanceTests(unittest.TestCase):
    ...
    def test_build_release_info_uses_current_release_changelog_entry_with_release_date(self) -> None:
        ...
        self.assertEqual(info["released_on"], "2026-07-13")
        ...
        self.assertIn("Managed Devices Fleet Summary layout", info["changes_preview"])
        self.assertIn("Unmanaged Candidate Queue", info["changes_preview"])
        self.assertIn("managed Fleet List", info["changes_preview"])
    ...
    def test_current_candidate_changelog_tracks_corrective_release_scope(self) -> None:
        ...
        self.assertIn("Managed Devices Fleet Summary layout", current_highlights)
        self.assertIn("Unmanaged Candidate Queue", current_highlights)
        self.assertIn("managed Fleet List", current_highlights)
