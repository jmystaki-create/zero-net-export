...
class TestBucketOwnershipCopy(unittest.TestCase):
    def test_bucket_ownership_and_workspace_split_stay_visible(self):
        ...
        self.assertIn("This is the main Managed Devices workspace.", devices_description)
        ...
        self.assertIn("Another ready unmanaged candidate: {ready_candidate}", edit_pick_description)
        ...
        self.assertIn("Another ready unmanaged candidate: {ready_candidate}", remove_description)
        ...
        self.assertIn("Another ready unmanaged candidate: {ready_candidate}", template_description)
        ...
        self.assertIn("Another ready unmanaged candidate: {ready_candidate}", shortlist_description)
        ...
        self.assertIn("Another ready unmanaged candidate: {ready_candidate}", full_list_description)
        ...
        self.assertIn("- Recommended section: {recommended_section}", support_description)
        self.assertIn("- Recommended next step: {next_action_summary}", support_description)
