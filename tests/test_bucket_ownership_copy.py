...
class TestBucketOwnershipCopy(unittest.TestCase):
    def test_bucket_ownership_and_workspace_split_stay_visible(self):
        ...
        self.assertIn("Use this command center for live setup and the current operating picture.", init_description)
        self.assertIn("then continue in the Managed Devices workspace when fleet work is next.", init_description)
        ...
        self.assertIn("Deeper per-device review path:", bulk_enable_description)
        ...
        self.assertIn("Deeper per-device review path after promotion:", vetting_description)
        ...
        self.assertIn("Deeper per-device review path after save:", add_description)
