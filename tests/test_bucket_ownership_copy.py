...
class TestBucketOwnershipCopy(unittest.TestCase):
    def test_bucket_ownership_and_workspace_split_stay_visible(self):
        ...
        self.assertIn("- Current focus section: {recommended_section}", init_description)
        ...
        self.assertIn("Current source bindings, for cross-check only:\n{source_mapping_summary}", source_mapping_description)
        ...
        self.assertNotIn("Managed devices (top section)", devices_description)
        ...
        self.assertIn("Secondary per-device ⚙ Settings review/audit path:", devices_description)
        self.assertNotIn("Secondary per-device review/audit path:", devices_description)
        ...
        self.assertNotIn("- Current focus section: {recommended_section}", support_description)
        ...
        self.assertIn("Source-role evidence: {sources_path}", support_description)
        self.assertNotIn("Source-map evidence: {sources_path}", support_description)
