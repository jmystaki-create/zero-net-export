...
- Hardened stale Source blockers, older fallback text, and source-role/path normalization across Managed Devices blocker handoffs, native setup notifications including Controls, bare section handoffs, and shorthand Configure bucket paths, command-center summaries, device-page guides, setup-check labels, setup checks, bare Configure source-role finish prompts, and next-action handoffs before cached or fallback text reaches Home Assistant.
