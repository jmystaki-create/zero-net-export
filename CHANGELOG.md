...
- Aligned Home Assistant source-role wording across the UI design/spec docs, product/validation docs, README setup/restart guidance, bootstrap copy, source-validation recommendations, Sensors source-health/progress headings, Controls readiness, setup checklist, and native readiness copy.
