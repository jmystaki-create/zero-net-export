...
### Fixed
- Trimmed the remaining verbose Diagnostics guide labels across Configure and the device-page Diagnostics path so Workstream F support surfaces stay blocker-first and secondary instead of reading like long helper narration.
