...
- Reworded Sensors and Diagnostics selector/fallback copy so native setup/support surfaces describe primary source-role choices normally, keep selector-rejection guidance in fallback-only fields, avoid reviving old picker-bug, workaround narration, and source-mapping validation phrasing, and keep default fallback guidance free of native-dropdown mechanics.
