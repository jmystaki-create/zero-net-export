...
- Aligned Home Assistant source-role wording across the UI design/spec docs, product/validation docs, README setup/restart guidance, bootstrap and active validation-checklist copy, validation run order, source-validation recommendations, Sensors source-health/progress headings, Controls readiness, setup checklist, setup notifications, and native readiness copy.
