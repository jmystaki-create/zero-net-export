...
- Added Managed Devices status to the command-center setup check and clarified Configure Fleet activity so managed inventory/action signals stay grouped ahead of unmanaged backlog across older count labels, delimiter variants, and compact native Home Assistant surfaces.
