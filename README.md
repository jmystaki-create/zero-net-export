...
- **Native Home Assistant operator surfaces**: Configure, the integration device page, entities, notifications, Repairs, and a native Lovelace expert operator dashboard inside Home Assistant are the supported operator path.
