...
def _normalize_native_path_text(text: Any) -> str:
    ...
    replacements = {
        ...
        "Start in the unmanaged section": "Review unmanaged candidates in Managed Devices",
        "start in the unmanaged section": "review unmanaged candidates in Managed Devices",
        "Review the unmanaged section": "Review unmanaged candidates in Managed Devices",
        "review the unmanaged section": "review unmanaged candidates in Managed Devices",
        "Promote next from the unmanaged section": "Promote the ready unmanaged candidate in Managed Devices",
        "promote next from the unmanaged section": "promote the ready unmanaged candidate in Managed Devices",
