...
4. The historical `v0.1.91` tag at `7217f3b`, the post-tag `c4802a3` component boundary, and the newer `db5c246` / `v0.1.92` freeze are not deploy approval. Ask James directly for the release-target decision first: whether `db5c246` / `v0.1.92` replaces the documented `0.1.91` target or release execution returns to the approved `0.1.91` boundary.
