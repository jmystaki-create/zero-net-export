...
5. The remaining boundary is the approved Home Assistant install/update, restart, fingerprint, and live validation pass for `v0.1.90`; after the installed package changes, perform screenshot-grade device-page evidence capture.
...
For `0.1.90`, after James approves or performs the Home Assistant install/update plus restart/live validation step, validate in this order:
